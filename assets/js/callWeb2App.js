...
class CallWeb2App {
	...
	callWeb2app(scheme, fallbackUrl) {
		const androidIntent = this.settings.package
			? ["intent:" + scheme + "#Intent", "package=" + this.settings.package, "S.browser_fallback_url=" + encodeURIComponent(fallbackUrl), "end;"].join(
					";"
			  )
			: "";
		var web2appOptions = {
